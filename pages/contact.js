  ...
  <Page
    ...
    >
      ...
      <section className="container m-auto flex flex-col py-10 max-w-xl text-center px-6">
        ...
        <p className="text-justify text-lg leading-normal mb-4 text-grey-darkest mt-1 lg:mt-4 max-w-lg m-auto">Indien de afspraakmogelijkheden die online worden aangeboden naar uw gevoel te ver in de toekomst liggen en u liever sneller behandeld wordt, kan u mij steeds telefonisch contacteren. We trachten dan in wederzijds overleg een toch zo spoedig als mogelijk een behandelmoment in te.</p>
      </section>
          ...
          <div className="container m-auto flex flex-col py-2 max-w-xl text-center px-6">
            <div className="w-full w-1/2 flex flex-row justify-between md:justify-center items-center md:p-2 md:p-8 items-center md:items-start">
              <div className="flex items-center border-r p-4 w-1/2">
                <div>
                  <h2 className="text-kevin-green pb-2 font-medium">Telefonisch</h2>
                  <p className="text-grey-darkest text-lg leading-normal">
                    Op het nummer <a href="tel:0477 92 72 02" className="no-underine text-kevin-green" title="0477 92 72 02">
                    0477 92 72 02
                    </a>
                  </p>
                </div>
