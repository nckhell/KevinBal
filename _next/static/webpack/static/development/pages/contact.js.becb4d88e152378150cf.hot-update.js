...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_layouts_main__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    className: "my-8 font-sans container max-w-xl m-auto flex flex-col md:flex-row",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 9
    },
    ...
    className: "w-full md:w-1/2 flex flex-col justify-start items-start px-6 py-0 md:py-8 md:px-8 lg:items-start",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 10
    },
    ...
    __self: this
  }, "Dat kan telefonisch of online."), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("p", {
    className: "leading-normal text-lg mb-4 text-grey-darkest",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 13
    },
    ...
    className: "w-full md:w-1/2 flex flex-row md:flex-col justify-between md:justify-center items-center p-2 md:p-8 items-center md:items-start",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 15
    },
    ...
    className: "flex items-center sm:border-r md:border-b md:border-r-0 p-4 w-1/2 md:w-auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 16
    },
    ...
    className: "flex items-center p-4 w-1/2 md:w-auto",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 23
    },
...
//# sourceMappingURL=contact.js.becb4d88e152378150cf.hot-update.js.map