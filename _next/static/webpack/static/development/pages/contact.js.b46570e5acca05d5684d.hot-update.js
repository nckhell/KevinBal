...
/* harmony default export */ __webpack_exports__["default"] = (function () {
  return react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_components_layouts_main__WEBPACK_IMPORTED_MODULE_1__["default"], {
    ...
    className: "container m-auto flex flew-row md:flex-col py-2 max-w-xl text-center px-6",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 21
    },
    ...
    className: "w-full md:w-1/2 flex flex-row justify-between md:justify-center items-center p-2 md:p-8 items-center md:items-start",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 22
    },
    ...
    className: "w-full flex flex-row items-center p-4 md:w-1/2 ",
    __source: {
      fileName: _jsxFileName,
      lineNumber: 33
    },
...
//# sourceMappingURL=contact.js.b46570e5acca05d5684d.hot-update.js.map